...
<body>
<%
Object usin=session.getAttribute("userin"); 
String se="";  
if (usin == null){
...
String updatenum=(String)request.getParameter("carupnum");
String updaatename=request.getParameter("updatename");
