...
sql9="SELECT * FROM `product` WHERE `product_name`LIKE'%伊布'";
ResultSet rs9=con.createStatement().executeQuery(sql9);
sql10="SELECT * FROM `product` WHERE `pid` BETWEEN '39' AND '43'";
...
<!--網頁標頭結束-->
	...
	<section class="series">
        <div class="tab">
            <div class="item">
                  <div class="title-big">
                        <img src="../image/傳說蛋.png" alt="Fire">
                        <p class="title">神獸/Legendary</p>
                    </div>					  
					  <div class="list">
					  <%while(rs10.next()){%>
					  <div class="p-item">
					    <a href="productdetail.jsp?id=<%=rs10.getInt(1)%>"><img src="../image/<%=rs10.getString(3)%>.png" class=" rounded-lg w-[18vw]" /></a><br>
					    <p class="product_name10"><%=rs10.getString(3)%><br>
					 </div>
				    <%}%>
					  </div>	
				</div>
