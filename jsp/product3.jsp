...
<!--網頁標頭結束-->
	...
	<section class="series">
        <div class="tab">
            <div class="item">
                 <div class="title-big">
                        <img src="../image/小Flying.png" alt="Fire">
                        <p class="title">飛行系/Flying</p>
                    </div>					  
					  <div class="list">
					  <%while(rs7.next()){%>
					  <div class="p-item">
					    <a href="productdetail.jsp?id=<%=rs7.getInt(1)%>"><img src="../image/<%=rs7.getString(3)%>.png" class=" rounded-lg w-[18vw]" /></a><br>
					    <p class="product_name7"><%=rs7.getString(3)%><br>
					 </div>
				    <%}%>
					  </div>	
				</div>
				<div class="item">
                  <div class="title-big">
                        <img src="../image/小Ghost.png" alt="Fire">
                        <p class="title">幽靈系/Ghost</p>
                    </div>					  
					  <div class="list">
					  <%while(rs8.next()){%>
					  <div class="p-item">
					    <a href="productdetail.jsp?id=<%=rs8.getInt(1)%>"><img src="../image/<%=rs8.getString(3)%>.png" class=" rounded-lg w-[18vw]" /></a><br>
					    <p class="product_name8"><%=rs8.getString(3)%><br>
					 </div>
				    <%}%>
					  </div>
				</div>
