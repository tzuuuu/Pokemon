...
<!--網頁標頭結束-->
	...
	<section class="series">
        <div class="tab">
            <div class="item">
                  <div class="title-big">
                        <img src="../image/小Eevee.png" alt="Fire">
                        <p class="title">伊布/Eevee</p>
                    </div>					  
					  <div class="list">
					  <%while(rs9.next()){%>
					  <div class="p-item">
					    <a href="productdetail.jsp?id=<%=rs9.getInt(1)%>"><img src="../image/<%=rs9.getString(3)%>.png" class=" rounded-lg w-[18vw]" /></a><br>
					    <p class="product_name9"><%=rs9.getString(3)%><br>
					 </div>
				    <%}%>
					  </div>	
				</div>
